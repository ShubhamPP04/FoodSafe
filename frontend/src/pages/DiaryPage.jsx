      ...
      {total === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 px-6 text-center border border-dashed border-rule rounded-[32px] bg-surface-100/30">
          ...
          <p className="text-ink-2 text-[15px] leading-relaxed max-w-sm font-medium">
            ...
            <span className="text-ink-3 text-sm mt-2 block">{t(lang, 'startScanning')}</span>
          </p>
        </div>
      ) : (
                ...
                <div className="flex flex-col sm:flex-row items-center gap-8 relative z-10">
                  <div className="shrink-0 relative">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                      <span className="text-2xl font-sans font-bold text-ink leading-none">{total}</span>
                    </div>
                  </div>
                  <div className="flex flex-col gap-3 w-full">
                    {riskCounts.map((r, i) => (
                      <div key={i} className="flex items-center justify-between text-sm py-1.5 border-b border-rule last:border-0">
                ...
                <div className="bg-surface-100 border border-rule rounded-[24px] overflow-hidden p-5 shadow-xl">
                  {loadingInsights ? (
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      {aiInsights?.warning && (
                        <div className="p-4 rounded-xl bg-chili/10 border border-chili/30 text-[13px] text-chili leading-relaxed flex gap-3">
